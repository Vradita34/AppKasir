    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 grid lg:grid-cols-2 gap-8 lg:gap-16">
        <div class="flex flex-col justify-center">
            <h1
                ...
                Aplikasi Kasir berbasis Web</h1>
            <p class="mb-6 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">Memudahkan anda dalam
                mengelola data penjualan dan pembelian produk di toko/perusahaan anda :D
            </p>
            <a href="#"
            ...
            <div class="w-full lg:max-w-xl p-6 space-y-8 sm:p-8 bg-white rounded-lg shadow-xl dark:bg-gray-800">
                ...
                @if (session('LoginErr'))
                    <div id="toast-warning"
                        ...
                        <div class="ms-3 text-sm font-normal">{{ session('LoginErr') }}.</div>
                        <button type="button"
                ...
                @if (session()->has('status'))
                    <div class="flex items-center p-4 mb-4 text-sm text-green-800 border border-green-300 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 dark:border-green-800"
                        ...
                        <div>
                            <span class="font-medium">Successfull</span> {{ session()->get('status') }}
                        </div>
                    </div>
                @endif
                ...
                <form class="mt-8 space-y-6" action="/auth" method="POST">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="email"
                            ...
                            placeholder="name@gmail.com" required autofocus @error('email') is-invalid @enderror
                            value="{{ old('email') }}">
                        @error('email')
