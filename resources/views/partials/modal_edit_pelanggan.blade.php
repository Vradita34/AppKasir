<div id="crud-modal{{ $no }}" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <form class="p-4 md:p-5" action="{{ route('edit.pelanggan', ['pelanggan' => $cuy->id]) }}" method="POST">
                @method('put')
                @csrf
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                        ...
                        <input type="text" name="nama" id="nama"
                            ...
                            placeholder="Type product name" required value="{{ old('nama', $cuy->nama) }}"
                            @error('nama')
                    ...
                    <div class="col-span-2 ">
                        ...
                        <input type="number" name="no_telp" id="no_telp"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Rp. 20.000" required value="{{ old('no_telp', $cuy->no_telp) }}"
                            @error('no_telp')
                                is-invalid @else is-valid
                            @enderror>
                        @error('no_telp')
